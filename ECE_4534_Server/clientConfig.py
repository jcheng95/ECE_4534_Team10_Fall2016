...
if __name__=='__main__':
    ...
    print('Setting up the SSID to connect to "team10"')
    usb.write(b'set wlan ssid team10\r')
    time.sleep(3)
    print('Setting the pass phrase to be "raspberry"')
    usb.write(b'set wlan pass raspberry\r')
    time.sleep(3)
    print('Setting the client to attempt to connect every 2 seconds')
    usb.write(b'set sys autoconn 2\r')
    time.sleep(3)
    print('Setting the IP address to connect to as 10.0.0.1')
    # Connects to the host IP it's looking for
    usb.write(b'set ip host 10.0.0.1\r')
    time.sleep(3)
    print('Setting the IP port to be 2000')
    usb.write(b'set ip remote 2000\r')
    time.sleep(3)
