...
typedef enum {forward = 1, left = 2, right = 3, backward = 4, stop = 5} directions;
...
typedef struct
{
    ...
    int16_t error;
    int16_t integral;
    int16_t prevEncoderTicks;
    int16_t sensorError;
    int16_t prevSensorError;
...
typedef struct
{
    ...
    int16_t weighted_lfData;
    directions roverDirection;
    int intersectionCounter;
    MOTOR_CONTROL_VALUES rightMotor;
    MOTOR_CONTROL_VALUES leftMotor;
    MOTOR_CONTROL_VALUES stopValues;
    MOTOR_CONTROL_VALUES fullSpeedValues;
    int tickCounter;
